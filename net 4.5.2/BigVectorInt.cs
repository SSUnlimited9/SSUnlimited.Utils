...
namespace System.Numerics.Vectors
{
	...
	public struct BigVector3Int
	{
		...
		private static readonly BigVector3Int left = new BigVector3Int(BigInteger.MinusOne, BigInteger.Zero, BigInteger.Zero);
		private static readonly BigVector3Int right = new BigVector3Int(BigInteger.One, BigInteger.Zero, BigInteger.Zero);
		private static readonly BigVector3Int up = new BigVector3Int(BigInteger.Zero, BigInteger.One, BigInteger.Zero);
		private static readonly BigVector3Int down = new BigVector3Int(BigInteger.Zero, BigInteger.MinusOne, BigInteger.Zero);
		private static readonly BigVector3Int forward = new BigVector3Int(BigInteger.Zero, BigInteger.Zero, BigInteger.One);
		private static readonly BigVector3Int backward = new BigVector3Int(BigInteger.Zero, BigInteger.Zero, BigInteger.MinusOne);
		private static readonly BigVector3Int zero = new BigVector3Int(BigInteger.Zero, BigInteger.Zero, BigInteger.Zero);
		private static readonly BigVector3Int one = new BigVector3Int(BigInteger.One, BigInteger.One, BigInteger.One);
		private static readonly BigVector3Int minusone = new BigVector3Int(BigInteger.MinusOne, BigInteger.MinusOne, BigInteger.MinusOne);

		public static BigVector3Int Left => left;
		public static BigVector3Int Right => right;
		public static BigVector3Int Up => up;
		public static BigVector3Int Down => down;
		public static BigVector3Int Forward => forward;
		public static BigVector3Int Backward => backward;
		public static BigVector3Int Zero => zero;
		public static BigVector3Int One => one;
		public static BigVector3Int MinusOne => minusone;
	}
